  ...
  return (
    <div className="flex w-full items-center gap-3 rounded-daily-recommend bg-daily-recommend p-4">
      ...
      <div className="flex flex-col gap-0.5">
        <p className="font-display text-daily-title font-bold text-foreground">
          Recomendación del Día
        </p>
        <p className="font-ui text-[13px] font-normal text-muted">
          Try our local craft IPAs paired with cod croquetas.
        </p>
      </div>
    </div>
  );
